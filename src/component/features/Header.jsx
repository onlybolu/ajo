...
const Header = () => {
  ...
  return (
    <div className='flex justify-between items-center  border-b border-gray-300' style={{background:"linear-gradient(#ece6cb,#e3e5e6)",paddingBottom:"10px",paddingLeft:"10px"}}>
        <Logo/>
        ...
        {/* <div className="d-none d-md-flex text-center align-items-center md:flex gap-8" style={{paddingTop:"23px"}}>
          ...
          <a href="#" className="text-black" style={{textDecoration:"none"}}>Contact</a>
            ...
            <div className="login flex gap-4  d-md-flex">
